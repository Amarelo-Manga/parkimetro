<?php
class bloco_text_sobre1{
    protected static $metabox_config = array(
        'bloco1_sobre', // Metabox Name
        'Texto sobre nós - bloco 1', // Metabox Title
        'page', // PostType do Metabox
        'normal'
    );
    ...
    static function metabox(){
        ...
        if(!isset($metadata['bloco1_sobre'])){ //Name do Metabox
           $content = "";
        }else{
            $content = $metadata['bloco1_sobre'][0]; //Name do Metabox
        };
    ?>  
